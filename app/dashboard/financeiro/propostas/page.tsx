...
export default function DashboardFinanceiroPropostasPage() {
  return (
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold text-yellow-400">
              Propostas do Financeiro
            </h1>
            <p className="mt-3 text-white/75">
              Área financeira dedicada para consulta de propostas, sem redirecionar para contextos globais.
            </p>
          </div>
